...
RUBRIC_GENERATION_PROMPT = (
    ...
    "6. Criteria must test INDEPENDENT KNOWLEDGE — not merely whether the answer "
    "echoes or restates words from the question. "
    "BAD: \"mentions [term from question]\". "
    "GOOD: \"correctly explains [mechanism/treatment/fact] related to [term]\". "
    "A criterion that any copy-paste of the question would trivially satisfy is worthless.\n"
