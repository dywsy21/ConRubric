            ...
            for batch_idx, mini_batch in enumerate(mini_batches):
                ...
                for micro_batch in micro_batches:
                    ...
                    if calculate_entropy and entropy is not None:
                        ...
                        # Entropy cap: full bonus below cap, zero at cap, penalty above.
                        # Above cap the penalty grows linearly scaled 5x base coeff
                        # so high entropy is actively pushed back down.
                        ...
                        if entropy_cap > 0 and observed_entropy > entropy_cap:
                            # Immediate cutoff + linear penalty above cap
                            excess_ratio = (observed_entropy - entropy_cap) / entropy_cap
                            effective_entropy_coeff = -entropy_coeff * 5.0 * excess_ratio
                        else:
